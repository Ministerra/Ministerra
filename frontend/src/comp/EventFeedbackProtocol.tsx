...
const feedbackAreas = [
	{
		...
		praises: [
			...
			{ id: 'inspiring', label: 'Inspirativní a motivující', desc: 'Odnesl jsem si nové myšlenky, podněty a energii do dalších dnů', icon: '/icons/gallery/trusted.png' },
	...
	},
	{
		...
		praises: [
			...
			{ id: 'communication', label: 'Proaktivní a jasná komunikace', desc: 'Včasné informace, aktualizace, notifikace změn', icon: '/icons/gallery/trusted.png' },
	...
	},
	{
		...
		praises: [
			...
			{ id: 'energy_positive', label: 'Pozitivní a nabíjející energie', desc: 'Skvělá atmosféra, nadšení účastníků, dobrá nálada', icon: '/icons/gallery/trusted.png' },
	...
	},
	{
		...
		praises: [
			...
			{ id: 'seating_comfy', label: 'Pohodlné sezení a prostor', desc: 'Kvalitní židle, dostatek místa, ergonomie', icon: '/icons/gallery/trusted.png' },
	...
	},
	{
		...
		praises: [
			...
			{ id: 'memorable', label: 'Nezapomenutelný a transformativní zážitek', desc: 'Změnilo to můj pohled, zážitek na celý život', icon: '/icons/gallery/trusted.png' },
